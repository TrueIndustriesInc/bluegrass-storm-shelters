...
export function PrintButton() {
  return (
    <button
      ...
      className="not-prose inline-flex items-center gap-2 rounded-lg bg-navy-800 px-5 py-3 text-sm font-semibold text-cream-50 shadow-soft transition-colors hover:bg-navy-700 print:hidden"
    >
      <svg
        viewBox="0 0 20 20"
        fill="currentColor"
